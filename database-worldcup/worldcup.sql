...
--
-- Name: games fk_games_opponents_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_games_opponents_id FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
